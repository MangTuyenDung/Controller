...
public interface JobCategoryRepository {
    ...
    List<JobCategoryDomain> findAll();

    JobCategoryDomain findById(int id);

    JobCategoryDomain findByUrl(@Param(value = "url") String url);

    void save(JobCategoryDomain domain);

    void update(JobCategoryDomain domain);
}
