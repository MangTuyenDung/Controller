 ...
 */
package vn.mangtuyendung.controller.company;
...
/**
 *
 * @author Tran Anh Tuan <admin@hadoopvietnam.com>
 */
@RequestMapping("/tao-ho-so-cong-ty")
@Controller
public class CompanyCreateController extends SiteAbstractController {
    ...
    @ResponseBody
    public ValidationResponse updateCompanyAjaxJson(Model model, @ModelAttribute("educationForm") PersonEducationForm form, HttpServletRequest request, BindingResult bindingResult) {
